...
#         self.control_freq = 6.0 # Hz (Matches 1/dt of your training data)
...
class DiffusionInferenceNode(Node):
    def __init__(self):
        ...
        # [CHANGE] Use 16 steps for fast DDIM sampling
        self.num_inference_steps = 16 
        
        # --- 2. Load Model & Stats ---
        self.load_checkpoint()

        # --- 3. Runtime State (Thread safety for asynchronous callbacks) ---
        ...
        # --- 6. Timer Loop (Sequential Control) ---
        self.timer = self.create_timer(1.0 / self.control_freq, self.control_loop)
    ...
    def load_checkpoint(self):
        ...
        # [CHANGE] Set the reduced number of inference steps
